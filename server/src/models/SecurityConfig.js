...
const securityConfigSchema = new mongoose.Schema({
  ...
  activeNamespaces: {
    publicCollection: {
      ...
      description: { type: String, default: "Publicly accessible LDA gazette regulations, FAR rules, and zoning master plans stored in MongoDB Vector Search." },
      accessScope: { type: String, default: "Public Citizen & Guest Access" },
    ...
    internalOfficerCollection: {
      ...
      description: { type: String, default: "Restricted collection containing LDA internal committee approvals, officer notes, and pending bylaws in MongoDB." },
      ...
      status: { type: String, default: "Active" },
      vectorEngine: { type: String, default: "MongoDB Vector Search (AES-256)" }
    }
  },
  redactionRules: {
